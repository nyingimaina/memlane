...
- **Scheduling & Job Management:** Hangfire (with SQLite storage) - To manage background backup tasks with built-in persistence and retries.
...
## Storage & Database
- **Metadata Storage:** SQLite - A zero-configuration, file-based database for job history, settings, and Hangfire state.
...
- **Scheduling:** Integrated Hangfire scheduler, with hooks for system-native Cron if needed.